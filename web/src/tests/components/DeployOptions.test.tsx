...
describe("DeployOptions node selection", () => {
  ...
  /** Two nodes carried a warning box while multi-node was unproven. Two
   *  nodes have since run and been measured, so the selector is a selector
   *  and picking a peer says only how many ranks it makes. */
  it("raises no notice when more than one node is selected", async () => {
