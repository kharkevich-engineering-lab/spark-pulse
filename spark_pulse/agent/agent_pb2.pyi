...
class GetNodeStats(_message.Message):
    __slots__ = ()
    def __init__(self) -> None: ...

class ListSnapshot(_message.Message):
    __slots__ = ("repo_path", "revision", "deep")
    ...
    revision: str
    deep: bool
    def __init__(self, repo_path: _Optional[str] = ..., revision: _Optional[str] = ..., deep: _Optional[bool] = ...) -> None: ...

class RemoveSnapshot(_message.Message):
    __slots__ = ("repo_path", "revision")
    REPO_PATH_FIELD_NUMBER: _ClassVar[int]
    REVISION_FIELD_NUMBER: _ClassVar[int]
    repo_path: str
    revision: str
    def __init__(self, repo_path: _Optional[str] = ..., revision: _Optional[str] = ...) -> None: ...
...
class GpuProcess(_message.Message):
    ...
    container_id: str
    def __init__(self, pid: _Optional[int] = ..., name: _Optional[str] = ..., used_memory_bytes: _Optional[int] = ..., container_id: _Optional[str] = ...) -> None: ...

class MemoryStat(_message.Message):
    __slots__ = ("total_bytes", "used_bytes", "available_bytes")
    ...
    used_bytes: int
    available_bytes: int
    def __init__(self, total_bytes: _Optional[int] = ..., used_bytes: _Optional[int] = ..., available_bytes: _Optional[int] = ...) -> None: ...

class DiskStat(_message.Message):
    __slots__ = ("mount", "total_bytes", "used_bytes", "free_bytes")
    ...
    used_bytes: int
    free_bytes: int
    def __init__(self, mount: _Optional[str] = ..., total_bytes: _Optional[int] = ..., used_bytes: _Optional[int] = ..., free_bytes: _Optional[int] = ...) -> None: ...

class NodeStats(_message.Message):
    __slots__ = ("gpus", "memory", "disks", "processes", "cpu_count", "load_average_1m", "unavailable")
    ...
    gpus: _containers.RepeatedCompositeFieldContainer[GpuStat]
    memory: MemoryStat
    disks: _containers.RepeatedCompositeFieldContainer[DiskStat]
...
class RunHostProbe(_message.Message):
    __slots__ = ("command", "timeout_seconds")
    COMMAND_FIELD_NUMBER: _ClassVar[int]
    TIMEOUT_SECONDS_FIELD_NUMBER: _ClassVar[int]
    command: str
    timeout_seconds: int
    def __init__(self, command: _Optional[str] = ..., timeout_seconds: _Optional[int] = ...) -> None: ...

class HostProbeResult(_message.Message):
...
class ConfigureFabric(_message.Message):
    ...
    interfaces: _containers.RepeatedCompositeFieldContainer[FabricInterface]
    peers: _containers.RepeatedCompositeFieldContainer[FabricPeer]
    def __init__(self, interfaces: _Optional[_Iterable[_Union[FabricInterface, _Mapping]]] = ..., peers: _Optional[_Iterable[_Union[FabricPeer, _Mapping]]] = ...) -> None: ...

class FabricInterface(_message.Message):
    __slots__ = ("netdev", "connection_name", "cidr", "mtu")
    ...
    cidr: str
    mtu: int
    def __init__(self, netdev: _Optional[str] = ..., connection_name: _Optional[str] = ..., cidr: _Optional[str] = ..., mtu: _Optional[int] = ...) -> None: ...

class FabricPeer(_message.Message):
    __slots__ = ("netdev", "address")
    NETDEV_FIELD_NUMBER: _ClassVar[int]
    ADDRESS_FIELD_NUMBER: _ClassVar[int]
    netdev: str
    address: str
    def __init__(self, netdev: _Optional[str] = ..., address: _Optional[str] = ...) -> None: ...

class FabricResult(_message.Message):
    __slots__ = ("ports", "pings", "steps")
    PORTS_FIELD_NUMBER: _ClassVar[int]
    PINGS_FIELD_NUMBER: _ClassVar[int]
    STEPS_FIELD_NUMBER: _ClassVar[int]
    ports: _containers.RepeatedCompositeFieldContainer[FabricPortState]
    pings: _containers.RepeatedCompositeFieldContainer[FabricPing]
    steps: _containers.RepeatedScalarFieldContainer[str]
    def __init__(self, ports: _Optional[_Iterable[_Union[FabricPortState, _Mapping]]] = ..., pings: _Optional[_Iterable[_Union[FabricPing, _Mapping]]] = ..., steps: _Optional[_Iterable[str]] = ...) -> None: ...

class FabricPortState(_message.Message):
    __slots__ = ("netdev", "cidr", "address_ok", "mtu", "mtu_ok")
    NETDEV_FIELD_NUMBER: _ClassVar[int]
    CIDR_FIELD_NUMBER: _ClassVar[int]
    ADDRESS_OK_FIELD_NUMBER: _ClassVar[int]
    MTU_FIELD_NUMBER: _ClassVar[int]
    MTU_OK_FIELD_NUMBER: _ClassVar[int]
    netdev: str
    cidr: str
    address_ok: bool
    mtu: int
    mtu_ok: bool
    def __init__(self, netdev: _Optional[str] = ..., cidr: _Optional[str] = ..., address_ok: _Optional[bool] = ..., mtu: _Optional[int] = ..., mtu_ok: _Optional[bool] = ...) -> None: ...

class FabricPing(_message.Message):
    __slots__ = ("netdev", "address", "reachable")
    NETDEV_FIELD_NUMBER: _ClassVar[int]
    ADDRESS_FIELD_NUMBER: _ClassVar[int]
    ...
    address: str
    reachable: bool
    def __init__(self, netdev: _Optional[str] = ..., address: _Optional[str] = ..., reachable: _Optional[bool] = ...) -> None: ...
...
class SnapshotListing(_message.Message):
    ...
    BYTES_PRESENT_FIELD_NUMBER: _ClassVar[int]
    revision: str
    present: bool
    files: _containers.RepeatedCompositeFieldContainer[SnapshotFile]
    bytes_present: int
    def __init__(self, revision: _Optional[str] = ..., present: _Optional[bool] = ..., files: _Optional[_Iterable[_Union[SnapshotFile, _Mapping]]] = ..., bytes_present: _Optional[int] = ...) -> None: ...

class SnapshotRemoval(_message.Message):
    __slots__ = ("removed", "freed_bytes", "paths")
