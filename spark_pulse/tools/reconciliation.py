...
CLUSTER_LABEL = "spark_pulse.cluster"
DEPLOYMENT_LABEL = "spark_pulse.deployment"
NAME_LABEL = "spark_pulse.name"
HEAD_IP_LABEL = "spark_pulse.head_ip"
WORKER_IPS_LABEL = "spark_pulse.worker_ips"
RAY_ENABLED_LABEL = "spark_pulse.ray_enabled"
RAY_READY_LABEL = "spark_pulse.ray_ready"
CREATED_AT_LABEL = "spark_pulse.created_at"
IMAGE_LABEL = "spark_pulse.image"
...
def _reconcile_clusters_real(remote_docker: Any = None) -> list[dict[str, Any]]:
    ...
    try:
        if remote_docker is not None:
            ...
            containers = remote_docker.list_managed_containers(
                host="local",
            ...
            try:
                ...
                logger.warning("Docker SDK not available, skipping real reconciliation")
                return []
